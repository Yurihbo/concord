...
function FriendsView() {
  ...
  const activeSignals = trpc.calls.signals.useQuery({ callId: activeCallId ?? 0 }, { enabled: Boolean(activeCallId), refetchInterval: 1500 });
