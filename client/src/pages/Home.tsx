...
function Workspace({ onLogout, userName, userId, publicId }: { onLogout: () => void; userName: string; userId?: number; publicId?: string }) {
  ...
  const voiceMutation = trpc.communities.createVoice.useMutation({ onSuccess: () => { toast.success("Sala de voz criada"); setNewVoiceName(""); setVoiceOpen(false); voiceQuery.refetch(); } });
