...
export default function FirebaseWorkspace() {
  ...
  const leaveVoiceRoom = async () => {
    ...
    setVoiceStream(null); setVoiceRoomId(null); setMuted(false); setLocalSpeaking(false); setScreenSharing(false); setScreenPreviewStream(null); setScreenViewerIds(new Set()); setRemoteStreams({}); setRemoteScreenStreams({}); setScreenVolumes({}); previousScreenBroadcasters.current = new Set();
