...
function RemoteAudio({ stream, peerId, unlockVersion, outputDeviceId, onBlocked }: { stream: MediaStream; peerId: string; unlockVersion: number; outputDeviceId?: string; onBlocked: () => void }) {
