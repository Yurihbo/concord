...
function FriendsView() {
  ...
  const finishCall = () => { playCallTone(330); callService.dispose(); audioStream?.getTracks().forEach((track) => track.stop()); setAudioStream(null); setLocalMedia(null); setRemoteMedia(null); setActiveCallId(null); setCallState("idle"); };
