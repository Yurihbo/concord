...
- [x] Auditar a paridade publicada do workspace Firebase com a versão original, incluindo arquivos e ações ausentes (workflow 32533521824 e inspeção visual do domínio concluídos)
- [x] Corrigir criação de comunidade/grupo e os diálogos para que sejam caixas acessíveis dentro do layout, não pop-ups deslocados (diálogo integrado confirmado no domínio)
